...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      confirmar_regularizacao: {
        Args: { _regularizacao_id: string }
        Returns: undefined
      }
      ...
      formata_valor_log: {
        Args: { _campo: string; _contexto?: Json; _valor: Json }
        Returns: string
      }
      garante_mensalidade: {
      ...
      rotulo_campo_log: { Args: { _campo: string }; Returns: string }
      solicita_convite: {
