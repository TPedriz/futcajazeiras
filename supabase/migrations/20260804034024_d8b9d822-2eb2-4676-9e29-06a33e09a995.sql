...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.locais_baba TO authenticated;
...
DROP TRIGGER IF EXISTS locais_baba_atualizado_em ON public.locais_baba;
...
SELECT 'Arena Cajazeiras', -12.898243032071784, -38.39820393037823, 1000
WHERE NOT EXISTS (SELECT 1 FROM public.locais_baba WHERE nome = 'Arena Cajazeiras');